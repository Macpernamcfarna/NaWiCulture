...
app.get("/languages", (req, res) => res.sendFile(path.join(__dirname, "public", "languages.html")));
app.get("/food-culture", (req, res) => res.sendFile(path.join(__dirname, "public", "food-culture.html")));
